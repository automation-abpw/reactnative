...
public class RegModerationWithExceptionHandling 

{
	...
	
	{
	   ...
	   // wait.until(ExpectedConditions.elementToBeClickable(element1));
		...
		Thread.sleep(9000);
		WebElement element12= WebDriverInit.getDriver().findElement(By.xpath("//td[contains(.,'Test user')]"));
	    wait.until(ExpectedConditions.textToBe(By.xpath("//td[contains(.,'Test user')]"),"Test user"));
	    exp1=element12.getText();
	    Thread.sleep(3000);
	    System.out.println(exp1);
	    
	    if(exp1.equals("Test user"))
	    {
	    Thread.sleep(3000);
		...
		catch (NoSuchElementException e)
		{
			...
			WebDriverInit.getDriver().findElement(By.xpath("//input[@type='search']")).click();
			WebDriverInit.getDriver().findElement(By.xpath("//input[@type='search']")).sendKeys(email);
			wait.until(ExpectedConditions.textToBe(By.xpath("//div[3]/div/table/tbody/tr/td[3]"),"Test user"));
...
/*NCf executive role selection*/
	    ...
	    WebElement element=  WebDriverInit.getDriver().findElement(By.xpath("//td[contains(.,'Test user')]"));
	    String usr = element.getText();
	    System.out.println(usr);
	    Assert.assertEquals("Test user", usr);
